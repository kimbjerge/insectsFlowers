...
if __name__=='__main__': 
    ...
    batch_size = 32
    epochs = 75 # 38 EfficientNetB0+others, 27 MobileNetV2, 25 InceptionV3, 35 ResNet50V2, 25 ResNet50V2 with imagenet
    ...
    if modelType == "ResNet": 
        model = tf.keras.models.load_model(models_dir + '/' +  'ResNet50v2-T35.h5')
    else:
        model = tf.keras.models.load_model(models_dir + '/' +  'EfficientNetB4-softmax-19cls-75.h5')
