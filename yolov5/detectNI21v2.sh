...
do
	...
	do
		...
		echo "$csvFile"
		python detectCSVNI2v2.py --weights insectsNI21-bestF1-1280m6.pt --img 1280 --conf 0.25 --save-txt --nosave --source "$filepath$system/$line/" --name "res$2" 
		mv "res$2.csv" "NI2/$csvFile"
	done < $input
